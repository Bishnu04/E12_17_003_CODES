...
void mg_optics(){
 ...
 // ((((((((((((((((((((((((((((((((((((((((((( for t2 ((((((((((
  ...
  TH1F *h53_1 = new TH1F("h53_1","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-101,151);
  TH1F *h53_2 = new TH1F("h53_2","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-102,150);
  TH1F *h53_3 = new TH1F("h53_3","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-103,149);
  TH1F *h53_4 = new TH1F("h53_4","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-104,148);
  TH1F *h53_5 = new TH1F("h53_5","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-99,153);
  TH1F *h53_6 = new TH1F("h53_6","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-98,154);
  TH1F *h53_7 = new TH1F("h53_7","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-97,155);
  TH1F *h53_8 = new TH1F("h53_8","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-96,156);

  TH1F *hb53 = new TH1F("hb53","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-100,152);
  TH1F *h53_1b = new TH1F("h53_1b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-101,151);
  TH1F *h53_2b = new TH1F("h53_2b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-102,150);
  TH1F *h53_3b = new TH1F("h53_3b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-103,149);
  TH1F *h53_4b = new TH1F("h53_4b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-104,148);
  TH1F *h53_5b = new TH1F("h53_5b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-99,153);
  TH1F *h53_6b = new TH1F("h53_6b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-98,154);
  TH1F *h53_7b = new TH1F("h53_7b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-97,155);
  TH1F *h53_8b = new TH1F("h53_8b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.5 MeV ",168,-96,156);  
  ...
  TH1F *h1_0 = new TH1F("h1_0","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-100,150);
  TH1F *h1_01 = new TH1F("h1_01","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-98,152);
  TH1F *h1_02 = new TH1F("h1_02","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-99,151);
  TH1F *h1_03 = new TH1F("h1_03","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-101,149);
  TH1F *h1_04 = new TH1F("h1_04","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-102,148);
  TH1F *h1_05 = new TH1F("h1_05","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-103,147);

  TH1F *h1_0b = new TH1F("h1_0b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-100,150);
  TH1F *h1_01b = new TH1F("h1_01b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-98,152);
  TH1F *h1_02b = new TH1F("h1_02b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-99,151);
  TH1F *h1_03b = new TH1F("h1_03b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-101,149);
  TH1F *h1_04b = new TH1F("h1_04b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-102,148);
  TH1F *h1_05b = new TH1F("h1_05b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ MeV ",250,-103,147);
 
  TH1F *h_75_1 = new TH1F("h_75_1","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ 0.76 MeV ",350,-100,166);
  TH1F *h_75_2 = new TH1F("h_75_2","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ 0.76 MeV ",350,-102,164);
  TH1F *h_75_3 = new TH1F("h_75_3","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ 0.76 MeV ",350,-103,163);
  TH1F *h_75_4 = new TH1F("h_75_4","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ 0.76 MeV ",350,-98,168);
  TH1F *h_75_5 = new TH1F("h_75_5","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ 0.76 MeV ",350,-99,167);

  TH1F *h_75_1b = new TH1F("h_75_1b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ 0.76 MeV ",350,-100,166);
  TH1F *h_75_2b = new TH1F("h_75_2b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ 0.76 MeV ",350,-102,164);
  TH1F *h_75_3b = new TH1F("h_75_3b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ 0.76 MeV ",350,-103,163);
  TH1F *h_75_4b = new TH1F("h_75_4b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ 0.76 MeV ",350,-98,168);
  TH1F *h_75_5b = new TH1F("h_75_5b","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/ 0.76 MeV ",350,-99,167);
 ...
 TH1F *h1_22 = new TH1F("h1_22","nnL Spectrum, T/T data  ; -B_{#Lambda}(MeV);Counts/1.52 MeV ",169,-100,157);
  ...
  TFile* f_new = new TFile("./output_root/quasi_free_march9.root","recreate");
  //  TObjArray h1_22(0);
  h1_22->Add(h1_2);
  h1_22->Add(h1_2b);
  h1_2->Write();
