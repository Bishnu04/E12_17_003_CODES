...
// monte caro study
// Author Bishnu
//This code will out put the parameters like energy, hrs momentum and those of the angles in the form of the root file.
// Target Deuterium and Lambda_n as recoil
//#include <cmath>
#include <iostream>
#include <iomanip>
#include <fstream>
...
void DEUTERIUM_first()
{
  ...
  mt = 1.8756282; // GeV Deuterium Target
  mk = 0.4937;  
  m_D = 2.05524863 ; // GeV   recoil mass 27_MG_L mass
  ...
  TFile *f1 = new TFile("./output_root/DEUTERIUM_first.root","recreate");
  f1->cd();
  ...
  for(int i=0;i< loop_num;i++)
    {
      ...
      A=(a*a + mk*mk - m_D*m_D - p_b*p_b - pep*pep + 2*p_b*pep*TMath::Cos(THETA_EP))/(2*a);
