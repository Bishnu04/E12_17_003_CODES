...
// monte caro study
// Author Bishnu
//This code gives some outputs like beam energy, Hrs momentum and angles in the form of root file
// Also the kinematics is done to calculate the kaon momentum
// Target Helium_4 and 4H_Lambda as recoil
...
void HELIUM_first()
{
  ...
  double m_He;// mass of 27Mg_L  recoil mass
  ...
  mt = 3.7274083; // GeV/c^2 4He or Helium
  mk = 0.4937;  
  m_He = 3.9246268; // GeV   recoil mass 4H_L
  ...
  TFile *f1 = new TFile("./output_root/HELIUM_first.root","recreate");
  f1->cd();
  ...
  for(int i=0;i< loop_num;i++)
    {
      ...
      A=(a*a + mk*mk - m_He*m_He - p_b*p_b - pep*pep + 2*p_b*pep*TMath::Cos(THETA_EP))/(2*a);
