...
//This code wil read the rootfile from carbon_second.cc and then will plot//
//the missing mass (BE) histogram for carbon target
...
void BE_carbon()
{
  ...
  t5->Add("./output_root/carbon_second.root");// Al as target
 ...
 TH1F *h5 = new TH1F("h5"," C target and ^{12}B_{#Lambda} as Recoil ",500,-25.0,25.0);
 TH1F *h6 = new TH1F("h6","C  as target and ^{12}B_{#Lambda}  as Recoil",100,-1.50e-3,1.5e-3);
 TH1F *h7 = new TH1F("h7","C  as target and ^{12}B_{#Lambda}  as Recoil",100,-1.5e-3,1.5e-3);
 TH1F *h8 = new TH1F("h8","C  as target and ^{12}B_{#Lambda}  as Recoil",100,-1.5e-3,1.5e-3);
 TH1F *h9 = new TH1F("h9"," C targetand ^{12}B_{#Lambda}  as Recoil  ",100,-20.0e-3,20.0e-3);
 TH1F *h10 = new TH1F("h10"," C target,and ^{12}B_{#Lambda}  as Recoil",100,-20.0e-3,20.0e-3);
 TH1F *h11 = new TH1F("h11"," C target, and ^{12}B_{#Lambda}  as Recoil",100,-30.0e-3,30.0e-3);
 ...
 h5->GetYaxis()->CenterTitle();
  ...
  TF1 *f5 = new TF1("f5","gaus",-1.2,1.2);
  ...
  l5.DrawLatex(-20,550,Form("^{12}B_{#Lambda}"));
  ...
  l11.DrawLatex(-0.5e-3,100,Form("#sigma_{#Delta#phi}  = 4.80*10^{-3}  Radian"));
