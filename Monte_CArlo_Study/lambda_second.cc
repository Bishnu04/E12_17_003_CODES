//03/20/2020
//This code will read the root file from the Lambda_first.cc and then By solving the kinematic equations it will calculate the Missing mass. This code will generate the errors as well
// Target Hydrogen and Lambda as Recoil.
...
void lambda_second()
{
  ...
  sigma_e = 4.3190*0.000067;  ///  tets value here  
