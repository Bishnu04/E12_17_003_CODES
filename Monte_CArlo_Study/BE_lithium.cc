...
//This code wil read the rootfile from lithium_second.cc and then will plot the Missing mass(BE) histogram
// Target Lithium
#include <iostream>
#include <iomanip>
#include <fstream>
...
void BE_lithium()
{
  ...
  t5->Add("./output_root/lithium_second.root");// Al as target
 ...
 TH1F *h5 = new TH1F("h5"," ^{7}Li target and ^{7}He_{#Lambda} as Recoil ",500,-25.0,25.0);
 TH1F *h6 = new TH1F("h6"," 7Li as target and ^{7}He_{#Lambda}  as Recoil",100,-1.50e-3,1.5e-3);
 TH1F *h7 = new TH1F("h7"," 7Li  as target and ^{7}He_{#Lambda}  as Recoil",100,-1.5e-3,1.5e-3);
 TH1F *h8 = new TH1F("h8"," 7Li  as target and ^{7}He_{#Lambda}  as Recoil",100,-1.5e-3,1.5e-3);
 TH1F *h9 = new TH1F("h9"," 7Li targetand ^{7}He_{#Lambda}  as Recoil  ",100,-20.0e-3,20.0e-3);
 TH1F *h10 = new TH1F("h10"," 7Li target,and ^{7}He_{#Lambda}  as Recoil",100,-20.0e-3,20.0e-3);
 TH1F *h11 = new TH1F("h11"," 7Li target, and ^{7}He_{#Lambda}  as Recoil",100,-30.0e-3,30.0e-3);
 ...
 h5->GetYaxis()->CenterTitle();
  ...
  l5.DrawLatex(-20,550,Form("^{7}He_{#Lambda}"));
