//03/20/2020
// This code will read the root file from HELIUM_first.cc
// will generate the errors and will do the kinematics for the missing Mass for Helium_4 target
...
void helium_second()
{
  ...
  t1->Add("./output_root/HELIUM_first.root");
  ...
  mt = 3.7274083 ; //Mass of 4He changed
  mk = 0.4937; 
  ...
  TFile *f2 = new TFile("./output_root/helium_second.root","recreate");
  f2->cd();
