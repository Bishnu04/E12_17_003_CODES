/*03/20/2020
 This code will read the root file from the Sigma_first.cc and then by solving the kinematic equatons will
calculate the missing mass for the Sigma. This code also have the error calulation for the Sigma_0 study 
