// 02/12/2020
// monte caro study for E12_17_003
// Author Bishnu
// This is the first code will out put some parameters like  beam energy, hrs momentum and hrs angles in the form of a root file. 
...
void Lambda_first()
{
  ...
  ktree->Branch("pep_1",&pep_1,"pep_1/D");
  ...
  for(int i=0;i< loop_num;i++)
    {
      pep_1=RndUni(pep_0_min,pep_0_max);
