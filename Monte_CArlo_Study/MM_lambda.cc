...
// This code will read the root  file generated by the lambda_second.cc and then make a plot for that
// Thisplot is about the missing mass of the Lambda particle
...
void MM_lambda()
{
 ...
 h5->GetYaxis()->CenterTitle();
  ...
  l5.DrawLatex(1025,1000,Form("#color[2]{mean = %.6g}",f5->GetParameter(1)));  // for H target
  l5.DrawLatex(1025,950,Form("#color[2]{#sigma = %.6g}",f5->GetParameter(2)));                                    
  l5.DrawLatex(1025,900,Form("#Lambda"));
  l5.DrawLatex(1025,850,Form("#sigma_{E} = 6.7*10^{-5} GeV"));
  l5.DrawLatex(1025,800,Form("#sigma_{Pee'} = #sigma_{Pk} = 1.0*10^{-4} GeV"));
  l5.DrawLatex(1025,750,Form("#sigma_{#theta_{ee'}} = #sigma_{#theta_{ek}} = 3.4*10^{-3} Radian"));
  l5.DrawLatex(1025,700,Form("#sigma_{#Delta#phi} = 4.8*10^{-3} Radian")); 
