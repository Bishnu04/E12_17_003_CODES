...
// monte caro study
// Author Bishnu
//This code will output some parameters like energy, hrs momentum and that of angles in the form of root file for the Carbon target
// This code ahs kinematics to calculate the kaon momentum
//#include <cmath>
#include <iostream>
#include <iomanip>
#include <fstream>
...
void CARBON_first()
{
  ...
  double m_C;// mass of 27Mg_L  recoil mass
  ...
  mt = 11.1749532; // GeV Carbon target
  mk = 0.4937;  
  m_C = 11.3478126; // GeV   recoil mass 27_MG_L mass
  ...
  TFile *f1 = new TFile("./output_root/CARBON_first.root","recreate");
  f1->cd();
  ...
  for(int i=0;i< loop_num;i++)
    {
      ...
      A=(a*a + mk*mk - m_C*m_C - p_b*p_b - pep*pep + 2*p_b*pep*TMath::Cos(THETA_EP))/(2*a);
